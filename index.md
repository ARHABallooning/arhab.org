...
For more information on ARHAB, [this Wikipedia entry](https://en.wikipedia.org/wiki/High-altitude_balloon#Amateur_High_Altitude_Ballooning) is a great introduction.

Or read the [UKHAS Beginners Guide to High Altitude Ballooning](https://ukhas.org.uk/general:beginners_guide_to_high_altitude_ballooning) to start planning your own flight.
...
[View archive of submitted flight missions](flight-archive.html)

[ARHAB.org (2018) on Wayback Machine](https://web.archive.org/web/20171202230935/http://arhab.org/)

The full site contents, including source code and all documents, are [available on Archive.org](https://archive.org/details/arhab.org-pre-2018-source-code).
